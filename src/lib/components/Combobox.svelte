<script>
	import { on_click_outside } from "$lib/actions";
...
<div class="combobox">
  <label class="combobox__label label form-label" for={id}>
    {label}
  </label>

  <div class="input-container" use:on_click_outside={hideList}>
    ...
    <ul
      class="combobox__list shadow bg-white rounded" 
      role="listbox"
			aria-label={label}
      hidden={!isListOpen}
