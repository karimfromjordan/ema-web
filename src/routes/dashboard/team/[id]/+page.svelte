...
<div>
	<div class="d-flex justify-content-end align-items-start mb-3">
		<div class="d-flex gap-2">
			<a href="/dashboard/team/{user.id}/edit" class="btn btn btn-primary">
				<Icon name="edit" />
				Bearbeiten
			</a>
		</div>
							...
							<div class="card-body">
								<div class="d-flex align-items-center gap-3">
									<img
										...
										src={user.profile_image || '/images/profile-circle.svg'}
										alt=""
									/>
									<div>
										<div class="fs-5 fw-semibold">{user.name}</div>
										<div>{user.employement_form}</div>
									</div>
								</div>
							</div>
						</div>
