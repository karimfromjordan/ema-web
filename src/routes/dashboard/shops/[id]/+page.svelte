<script>
	...
	import { shops } from '$lib/stores/firebase';
	...
	<div>
		<div class="d-flex justify-content-end align-items-start mb-3">
			<div class="d-flex gap-2">
				<a href="/dashboard/shops/{$shops.shop.id}/edit" class="btn btn btn-primary">
					<Icon name="edit" />
					Bearbeiten
				</a>
			</div>
								...
								<div>
									<div class="bg-primary-subtle d-flex" style="height: 7rem;">
										<div class="card-body text-primary">
											"Erfolg ist die Summe kleiner Anstrengungen, die Tag für Tag widerholt
											werden."
										</div>
									...
									>
										<div class="d-flex align-items-center gap-3">
											...
											<div>
												<div class="fs-5 fw-semibold">{$shops.shop.name}</div>
											</div>
										</div>
										<AvatarList
